...
router.get('/image', requirePermission('editar_ticket_template'), (req, res) => {
    try {
...
router.get('/template', requirePermission('editar_ticket_template'), (req, res) => {
    try {
...
router.put('/template', requirePermission('editar_ticket_template'), (req, res) => {
    try {
...
router.delete('/template', requirePermission('editar_ticket_template'), (req, res) => {
    try {
...
router.post('/preview', requirePermission('editar_ticket_template'), (req, res) => {
    try {
...
router.post('/upload-image', requirePermission('editar_ticket_template'), (req, res) => {
    try {
