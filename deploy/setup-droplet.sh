...
# --- Config ---
DOMAIN="${1:-tudominio.com}"   # Pasar el dominio como argumento: ./setup-droplet.sh midominio.com
DB_NAME="kareca_db"
DB_USER="kareca_user"
...
echo ""
echo "Next steps:"
echo "  1. Copy your code to $APP_DIR (excluye .env para no pisar el generado)"
echo "     rsync -avz --exclude=node_modules --exclude=.env ./Kareca/ user@IP:$APP_DIR/"
echo ""
...
echo "     Los secretos (DB_PASSWORD, JWT_SECRET) se generaron y guardaron en $APP_DIR/.env"
echo "=========================================="
